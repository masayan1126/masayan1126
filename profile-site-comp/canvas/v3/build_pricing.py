      ...
      <section class="estimate-notes" aria-labelledby="estimate-notes-heading">
        ...
        <div class="estimate-notes-copy">
          ...
          <ul>
            ...
            <li>撮影後〜編集完了前のキャンセルは、正式に確定したお見積もり総額（税込）の50%を頂戴いたします。</li>
          ...
          <ul>
            ...
            <li>動画はYouTubeで公開いたします。MP4などの動画ファイルの納品は含まれておりません。ファイルの提供をご希望の場合は、正式見積もり時にご相談ください。</li>
          ...
          <ul>
            ...
            <li>適格請求書は発行できません。仕入税額控除については、ご発注前に貴社の経理担当者へご確認ください。</li>
